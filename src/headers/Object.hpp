...
class Object{
        ...
        static double arctan (double x)
    {
        ...
        */
        ...
        float rotation;
        Object();
        Object(float x,float y,float sizex,float sizey,Color color);
        Object(Vector2 pos,Vector2 size,Color color);
        Object(Position pos,Vector2 size,Color color);
        Object(Object& obj);

        bool CheckCollision(Object& other);
        bool CheckCollision(Object& other,std::string tag);
